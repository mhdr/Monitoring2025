...
const LiveMonitoringDetailPage: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="row flex-fill" data-id-ref="live-monitoring-detail-page-row">
        <div className="col-12 h-100" data-id-ref="live-monitoring-detail-page-col">
          <div
            className="card h-100 d-flex flex-column"
            data-id-ref="live-monitoring-detail-page-card"
          >
            <div className="card-header" data-id-ref="live-monitoring-detail-page-card-header">
              <h4 className="card-title mb-0" data-id-ref="live-monitoring-detail-page-title">
                {t('liveMonitoring')}
              </h4>
            </div>
            <div
            ...
            >
              <p className="text-muted" data-id-ref="live-monitoring-detail-page-placeholder">
