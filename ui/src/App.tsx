  ...
  return (
      <Routes>
        ...
        <Route path="/dashboard" element={
          ...
          <Route path="memory/comparison-memory" element={
            <LazyErrorBoundary>
              <Suspense fallback={<LoadingScreen message={t('loading')} />}>
                <ComparisonMemoryManagementPage />
              </Suspense>
            </LazyErrorBoundary>
          } />
          <Route path="memory/statistical-memory" element={
            <LazyErrorBoundary>
              <Suspense fallback={<LoadingScreen message={t('loading')} />}>
                <StatisticalMemoryManagementPage />
              </Suspense>
            </LazyErrorBoundary>
          } />
          <Route path="memory/formula-memory" element={
            <LazyErrorBoundary>
              <Suspense fallback={<LoadingScreen message={t('loading')} />}>
          ...
          <Route path="memory/minmax-selector-memory" element={
            <LazyErrorBoundary>
              <Suspense fallback={<LoadingScreen message={t('loading')} />}>
