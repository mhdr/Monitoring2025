...
hub_connection.send(""SubscribeToActiveAlarms"", [])"
            ...
            if (pidMemories != null)
            {
                foreach (var pm in pidMemories)
                {
                    response.PIDMemories.Add(new GetPIDMemoriesResponseDto.PIDMemory()
                    {
                        Id = pm.Id,
                        Name = pm.Name,
                        InputType = (int)pm.InputType,
                        InputReference = pm.InputReference,
                        OutputType = (int)pm.OutputType,
                        OutputReference = pm.OutputReference,
                        Kp = pm.Kp,
                        Ki = pm.Ki,
                        Kd = pm.Kd,
                        ...
                        SetPointType = (int)pm.SetPointType,
                        SetPointReference = pm.SetPointReference,
                        ...
                        IsAutoType = (int)pm.IsAutoType,
                        IsAutoReference = pm.IsAutoReference,
                        ManualValueType = (int)pm.ManualValueType,
                        ManualValueReference = pm.ManualValueReference,
                        ReverseOutputType = (int)pm.ReverseOutputType,
                        ReverseOutputReference = pm.ReverseOutputReference,
                        DigitalOutputType = pm.DigitalOutputType.HasValue ? (int?)pm.DigitalOutputType.Value : null,
                        DigitalOutputReference = pm.DigitalOutputReference,
    ...
    public async Task<IActionResult> AddPIDMemory([FromBody] AddPIDMemoryRequestDto request)
    {
        try
        {
            ...
            {
                Name = request.Name,
                InputType = (Core.Models.PIDSourceType)request.InputType,
                InputReference = request.InputReference,
                OutputType = (Core.Models.PIDSourceType)request.OutputType,
                OutputReference = request.OutputReference,
                Kp = request.Kp,
                Ki = request.Ki,
                Kd = request.Kd,
                ...
                Interval = request.Interval,
                IsDisabled = request.IsDisabled,
                SetPointType = (Core.Models.PIDSourceType)request.SetPointType,
                SetPointReference = request.SetPointReference,
                ...
                IsAutoType = (Core.Models.PIDSourceType)request.IsAutoType,
                IsAutoReference = request.IsAutoReference,
                ManualValueType = (Core.Models.PIDSourceType)request.ManualValueType,
                ManualValueReference = request.ManualValueReference,
                ReverseOutputType = (Core.Models.PIDSourceType)request.ReverseOutputType,
                ReverseOutputReference = request.ReverseOutputReference,
                DigitalOutputType = request.DigitalOutputType.HasValue ? (Core.Models.PIDSourceType?)request.DigitalOutputType.Value : null,
                DigitalOutputReference = request.DigitalOutputReference,
            ...
            if (ifMemories != null)
            {
                foreach (var im in ifMemories)
                {
                    response.IfMemories!.Add(new GetIfMemoriesResponseDto.IfMemory()
                    {
                        ...
                        OutputDestinationType = (int)im.OutputDestinationType,
                        OutputReference = im.OutputReference,
    ...
    public async Task<IActionResult> AddIfMemory([FromBody] AddIfMemoryRequestDto request)
    {
        try
        {
            ...
            var ifMemory = new Core.Models.IfMemory
            {
                ...
                VariableAliases = request.VariableAliases,
                OutputDestinationType = (Core.Models.TimeoutSourceType)request.OutputDestinationType,
                OutputReference = request.OutputReference,
                OutputItemId = request.OutputItemId,
