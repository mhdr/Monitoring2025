...
/// <summary>
/// Request DTO for calculating the mean (average) value grouped by date for an analog point within a time range.
/// </summary>
public class PointMeanByDateRequestDto : IValidatableObject
{
    /// <summary>
    /// Identifier of the point to calculate mean for.
    /// </summary>
