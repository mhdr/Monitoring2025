...
/// <summary>
/// Request DTO for calculating the standard deviation grouped by date for an analog point within a time range.
/// </summary>
public class PointStdByDateRequestDto : IValidatableObject
{
    /// <summary>
