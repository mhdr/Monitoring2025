...
/// <summary>
/// Request DTO for counting data points grouped by date within a time range.
/// </summary>
public class PointCountByDateRequestDto : IValidatableObject
{
    /// <summary>
    /// Identifier of the point to count data for.
    /// </summary>
