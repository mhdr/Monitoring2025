...
/// <summary>
/// Request DTO for editing a formula memory configuration
/// </summary>
public class EditFormulaMemoryRequestDto
{
    /// <summary>
    /// ID of the formula memory to edit
    /// </summary>
    ...
    /// <summary>
    /// Optional display units for the output
    /// </summary>
