...
/// <summary>
/// Request DTO for calculating the maximum value grouped by date for an analog point within a time range.
/// </summary>
public class PointMaxByDateRequestDto : IValidatableObject
{
    /// <summary>
    /// Identifier of the point to calculate maximum for.
    /// </summary>
