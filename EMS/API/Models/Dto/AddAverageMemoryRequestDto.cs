...
/// <summary>
/// Request DTO for creating a new average memory / moving average configuration
/// </summary>
public class AddAverageMemoryRequestDto
{
    /// <summary>
    ...
    /// Format: [1.0, 2.0, 1.5, ...]
    /// Length must match InputItemIds if provided
    /// </summary>
    ...
    /// <summary>
    /// Stale timeout in seconds - inputs older than this are ignored
    /// </summary>
    ...
    /// <summary>
    /// Outlier threshold value (IQR multiplier or Z-score cutoff)
    /// </summary>
    [Range(0.01, 100, ErrorMessage = "Outlier threshold must be positive")]
    public double OutlierThreshold { get; set; } = 1.5;

    /// <summary>
    /// Minimum number of valid inputs required to compute average
    /// </summary>
    ...
    /// <summary>
    /// Use linear weights for WMA (true) or custom weights from Weights property (false)
    /// </summary>
